...
const styles = `
  *{box-sizing:border-box} html{scroll-behavior:smooth} body{margin:0;background:#fff8f7;color:#241d1f;font-family:Inter, ui-sans-serif, system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", sans-serif} button,input,textarea,select{font:inherit} button{cursor:pointer;border:0} input,textarea,select{width:100%;border:1px solid #f4d6df;border-radius:18px;padding:14px 16px;background:#fff;color:#241d1f;outline:none} textarea{min-height:96px;resize:vertical}.or-app{min-height:100vh;background:radial-gradient(circle at top,#fff 0,#fff3f6 46%,#fffaf8 100%);padding-bottom:112px}.or-main{width:min(1080px,100%);margin:0 auto;padding:26px 22px 40px}.or-header{position:relative;min-height:150px;display:flex;align-items:center;justify-content:center;text-align:center}.or-header h1{margin:0;color:#df7890;font-size:clamp(54px,8vw,86px);line-height:.9;font-weight:400;font-family:"Segoe Script","Brush Script MT",cursive;text-shadow:0 12px 28px rgba(224,110,140,.12)}.or-header p{margin:18px 0 0;text-transform:uppercase;letter-spacing:.32em;color:#8e7e82;font-weight:800}.top-icon{position:absolute;top:26px;width:50px;height:50px;border-radius:16px;background:transparent;color:#e26582;display:grid;place-items:center}.top-icon.left{left:0}.top-icon.right{right:0;color:#897d80}.top-icon span{position:absolute;right:-2px;top:-3px;background:#e95d7e;color:white;width:24px;height:24px;border-radius:999px;font-size:12px;display:grid;place-items:center;font-weight:900}.save-pop{position:sticky;top:10px;z-index:50;margin:0 auto 12px;width:max-content;background:white;color:#e75c80;border:1px solid #f5c8d4;border-radius:999px;padding:10px 18px;font-weight:900;box-shadow:0 12px 30px rgba(177,105,129,.16)}.or-card{background:rgba(255,255,255,.93);border:1px solid #f3d9df;border-radius:30px;padding:26px;margin-bottom:24px;box-shadow:0 16px 40px rgba(82,54,63,.09)}.or-card h2{font-size:32px;line-height:1.08;margin:0 0 10px;font-weight:900}.muted,.or-card p{color:#5b5052}.sync{margin-top:14px;color:#e05f80;font-weight:800}.grid{display:grid;gap:20px}.grid.two{grid-template-columns:repeat(2,minmax(0,1fr))}.insight-card{display:grid;grid-template-columns:106px 1fr;align-items:center;gap:24px}.insight-icon,.or-soft-icon{width:88px;height:88px;border-radius:999px;background:linear-gradient(145deg,#ffe8ef,#fff9fb);display:grid;place-items:center;color:#e66080;box-shadow:inset 0 0 0 1px #ffe1e9,0 14px 28px rgba(232,105,138,.16)}.rescue-card{overflow:hidden}.rescue-top{display:grid;grid-template-columns:150px 1fr 280px;gap:28px;align-items:center}.rescue-emblem{width:132px;height:132px;color:#e95b7d}.rescue-copy h2{font-size:46px;margin-bottom:6px}.rescue-copy h3{margin:0 0 22px;color:#e75f7f;font-size:18px;letter-spacing:.08em}.rescue-copy p{font-size:20px;line-height:1.45}.reset-button{margin-top:22px;width:min(570px,100%);min-height:105px;border-radius:999px;background:linear-gradient(135deg,#ff87a6,#df5c78);color:white;display:flex;align-items:center;justify-content:space-around;gap:20px;box-shadow:0 20px 35px rgba(217,84,115,.25);font-size:42px}.reset-button strong{font-size:27px;letter-spacing:.05em}.reset-button small{display:block;font-size:20px;font-weight:500;opacity:.95}.help-list{background:#fff7f8;border:1px solid #f7dce4;border-radius:24px;padding:20px}.help-list h4{margin:0 0 16px}.help-list p{display:flex;align-items:center;gap:14px;margin:14px 0}.help-list b{width:42px;height:42px;border-radius:999px;background:#f57392;color:white;display:grid;place-items:center}.safe-line{margin-top:24px;border:1px solid #f5d9e1;border-radius:18px;padding:16px 20px;color:#8a777a;background:#fff8f9;display:flex;gap:12px;align-items:center}.timer-box{margin-top:24px;background:#fff1f4;border-radius:28px;padding:28px;text-align:center}.timer-number{font-size:82px;line-height:1;font-weight:1000;color:#f45d80}.progress{height:16px;background:#f2eeee;border-radius:999px;overflow:hidden}.progress i{height:100%;display:block;background:linear-gradient(90deg,#fa6385,#f08aa4);border-radius:999px}.progress.gold i{background:linear-gradient(90deg,#d69b25,#f2c85b)}.timer-actions{display:grid;gap:14px;margin-top:22px}.timer-actions button{background:white;color:#ec4773;border-radius:22px;padding:18px;font-size:20px;font-weight:900;box-shadow:0 8px 18px rgba(80,50,60,.08)}.level-card{display:grid;grid-template-columns:120px 1fr 320px;align-items:center;gap:28px}.gold-medal{width:98px;height:98px;border-radius:999px;display:grid;place-items:center;color:#fff;background:linear-gradient(145deg,#f8cf6a,#d79318);box-shadow:inset 0 0 0 8px #ffe8aa,0 10px 24px rgba(170,111,24,.18)}.gold-medal svg{width:58px;height:58px}.level-card h2 span{font-size:16px;color:#bb8122;background:#fff0d4;padding:8px 13px;border-radius:999px}.level-progress p{text-align:right;font-weight:700}.stats-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:18px;margin-bottom:24px}.stat-card{background:white;border:1px solid #f0dbe1;border-radius:26px;padding:22px;text-align:center;box-shadow:0 12px 28px rgba(82,54,63,.08)}.stat-card span{font-size:34px}.stat-card p{margin:10px 0 2px;color:#7b6e71}.stat-card b{font-size:34px;color:#f05b80}.feature-grid{display:grid;grid-template-columns:repeat(5,minmax(0,1fr));gap:18px;margin-bottom:24px}.feature-card{background:white;border:1px solid #f0dfe3;border-radius:24px;min-height:168px;padding:18px;box-shadow:0 12px 28px rgba(82,54,63,.08);transition:.2s;color:#241d1f}.feature-card:hover{transform:translateY(-4px)}.feature-card .or-soft-icon{width:76px;height:76px;margin:0 auto 12px}.feature-card h3{font-size:17px;margin:0 0 5px}.feature-card p{font-size:14px;margin:0;color:#685b5e}.quick-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:14px}.quick-grid button,.primary,.list-button,.reward{border-radius:18px;padding:16px 18px;background:#fff0f4;color:#e64d75;font-weight:900}.primary{background:linear-gradient(135deg,#ff7899,#e85a7c);color:white;margin-top:12px}.field-card,.private-box{background:#fff4f6;border:1px solid #f5dce3;border-radius:22px;padding:18px;margin:12px 0}.field-card label,.field-card{font-weight:800}.field-card input,.field-card select{margin-top:8px}.form-row{display:grid;grid-template-columns:1fr auto;gap:12px;align-items:center;margin:12px 0}.form-row input[type="date"]{min-width:170px}.form-row select{width:160px}.list-button{width:100%;margin:9px 0;display:flex;gap:10px;align-items:center;justify-content:flex-start;background:#fff5f7;color:#2b2325}.list-button.done{background:#ffe5ed;color:#e64d75}.empty-circle{width:20px;height:20px;border:2px solid #e7b2c0;border-radius:999px}.saved-list{display:grid;gap:12px;margin-top:16px}.saved-item{background:#fff6f8;border:1px solid #f2dde4;border-radius:20px;padding:16px}.saved-item p{margin:5px 0}.saved-item small{color:#8a7a7e}.actions{display:flex;gap:10px;margin-top:12px}.actions button{background:white;border-radius:999px;padding:8px 14px;color:#e65378;font-weight:900;box-shadow:0 6px 14px rgba(80,50,60,.08)}.chips{display:flex;gap:10px;flex-wrap:wrap}.chips button{background:#fff0f4;color:#e65378;border-radius:999px;padding:10px 14px;font-weight:800}.reward{width:100%;display:flex;justify-content:space-between;margin:10px 0;background:#fff8e8;color:#9d6b16}.vault-card{background:linear-gradient(145deg,rgba(255,255,255,.96),rgba(255,242,247,.96))}.vault-head{display:flex;align-items:flex-start;justify-content:space-between;gap:16px}.lock-btn{width:52px;height:52px;border-radius:18px;background:#fff0f5;color:#e75d7d;display:grid;place-items:center}.vault-lock-screen{text-align:center;background:#fff6f9;border:1px solid #f3dbe3;border-radius:24px;padding:24px;margin-top:16px}.vault-lock-screen .or-soft-icon{margin:0 auto 12px}.vault-upload{display:grid;gap:12px;margin-top:12px}.upload-tile{min-height:116px;border:2px dashed #efb7c7;border-radius:24px;background:#fff8fa;color:#e75d7d;display:grid;place-items:center;text-align:center;font-weight:900;cursor:pointer;padding:18px}.upload-tile svg{width:34px;height:34px}.upload-tile input{display:none}.vault-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px;margin-top:18px}.vault-item{background:white;border:1px solid #f1dbe2;border-radius:22px;padding:12px;box-shadow:0 10px 22px rgba(82,54,63,.08)}.vault-media{width:100%;aspect-ratio:1/1;border-radius:18px;overflow:hidden;background:#fff0f4;margin-bottom:10px}.vault-media img,.vault-media video{width:100%;height:100%;object-fit:cover;display:block}.vault-item b{display:flex;align-items:center;gap:6px}.vault-item p{margin:6px 0;color:#685b5e;font-size:14px}.vault-item small{color:#98898d}.checks{display:grid;gap:8px;margin-top:16px}.checks span{background:#f8fff7;border-radius:14px;padding:10px}.empty{color:#8b7d80}.bottom-nav{position:fixed;left:0;right:0;bottom:0;z-index:100;background:rgba(255,255,255,.96);backdrop-filter:blur(14px);border-top:1px solid #f0d7df;display:grid;grid-template-columns:repeat(5,1fr);padding:10px max(10px,calc((100vw - 1080px)/2)) 12px;box-shadow:0 -12px 34px rgba(80,50,60,.08)}.bottom-nav button{background:transparent;color:#837579;display:flex;flex-direction:column;align-items:center;gap:5px;font-weight:900}.bottom-nav button span{width:48px;height:42px;border-radius:18px;display:grid;place-items:center}.bottom-nav button.active{color:#e75d7d}.bottom-nav button:nth-child(3) span{width:68px;height:68px;margin-top:-34px;border-radius:999px;background:linear-gradient(135deg,#f684a3,#df5578);color:white;box-shadow:0 16px 30px rgba(216,81,112,.28)}@media(max-width:900px){.grid.two,.rescue-top,.level-card,.stats-grid{grid-template-columns:1fr}.feature-grid{grid-template-columns:repeat(2,1fr)}.quick-grid{grid-template-columns:1fr 1fr}.insight-card{grid-template-columns:1fr;text-align:center}.insight-icon{margin:auto}.rescue-top{text-align:center}.rescue-emblem{margin:auto}.level-progress p{text-align:left}.form-row{grid-template-columns:1fr}.form-row select{width:100%}.or-main{padding:18px 14px 38px}.or-header{min-height:135px}.bottom-nav b{font-size:12px}}@media(max-width:520px){.feature-grid,.quick-grid{grid-template-columns:1fr}.stats-grid{grid-template-columns:repeat(2,1fr)}.or-card{padding:20px;border-radius:24px}.reset-button{min-height:88px}.reset-button strong{font-size:21px}.reset-button span{font-size:32px}.timer-number{font-size:64px}.rescue-copy h2{font-size:36px}.or-header h1{font-size:56px}}
`;
